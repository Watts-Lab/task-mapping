...
export default class Game0 extends React.Component {
    constructor(props) {
        super(props);
    ...
    resetCanvas() {
        ...
        var horizontalBar = Matter.Bodies.rectangle(130, 220, 20, 5, 
            {
                isStatic: true, 
                friction: 0.4,
                render: {
        ...
        var greenBall = Matter.Bodies.circle(130, 213, 10, 
            {
                friction: 0.4,
                render: {
        ...
        Matter.World.add(engine1.world, [ground, horizontalBar, cup, blueBall, greenBall]);
