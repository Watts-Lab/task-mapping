...
export default class Game1 extends React.Component {
    ...
    resetCanvas() {
        ...
        var horizontalBar = Matter.Bodies.rectangle(160, 230, 100, 5, 
            {
                isStatic: true, 
                friction: 0.4,
                render: {
        ...
        var leftTilted = Matter.Bodies.rectangle(50, 270, 200, 5, 
            {
                isStatic: true, 
                angle: -40, 
                render: {
        ...
        var rightTilted = Matter.Bodies.rectangle(350, 270, 200, 5, 
            {
                isStatic: true, 
                angle: 40, 
                render: {
        ...
        var greenBall = Matter.Bodies.circle(130, 210, 10, 
            {
                friction: 0.4,
                render: {
        ...
        Matter.World.add(engine1.world, [ground, horizontalBar, leftTilted, rightTilted, cup, blueBall, greenBall]);
        ...
        return (
            <div style={{marginLeft: "50px", marginTop: "50px"}}>
                ...
                style={{
                    fontSize: "18px",
                    maxWidth: "80rem"
                }}> In this task, your goal is to make the green ball collide with the blue ball by adding a larger ball 
                    (about 2x the size of the blue ball) to 
                    the canvas. To do so, please use your mouse to click on the location where you want the ball to appear.
                </p>
                <h3
                style={{                
                    fontSize: "25px",
