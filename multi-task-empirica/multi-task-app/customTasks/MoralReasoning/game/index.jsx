...
export default class MoralReasoning extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      ...
      >
        ...
        <div className='case-text' style={{display: "flex", flexDirection: "row"}}>
          <div className="case-story mr-10 px-2" style={{width: "60%", overflow: "scroll", height:"80vh"}}>
            ...
            <div>
              <strong>
                {otherPlayers.length > 0
                  ? 'All the players in your group will work on the same board. Think about the scenario. Select an answer that you think best describes it. Justify your answer in the text box. Click Approve Configuration to move on.'
                  : 'Think about the scenario. Select an answer that you think best describes it. Justify your answer in the text box. Click Approve Configuration to move on'}
              </strong>
            </div>
            <div className='flex flex-col gap-6'>
              <div>
                <RadioGroup
                  ...
                  options={[
                    {
                      label: "YTA = You're the Asshole",
                      value: 'YTA',
                    },
                    {
                      label: 'NTA = Not the Asshole',
                      value: 'NTA',
                    },
                    {
                      label: 'ESH = Everyone Sucks here',
                      value: 'ESH',
                    },
                    {
                      label: 'NAH = No Assholes here',
                      value: 'NAH',
                    },
                    {
                      label: 'INFO = Not Enough Info',
                      value: 'INFO',
                    },
                  ]}
                />
