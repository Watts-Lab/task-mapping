        ...
        <div>
          {inside || showOverview ? (
            <div style={{marginBottom: '20px'}}>
              ...
              <p>
                In this game, you will be shown photos of wildlife and asked to annotate them by
                answering a series of questions about them.
              </p>
              <p>
                <strong>Goal:</strong> Correctly answer all questions regarding the pictures
              </p>
              <p>
                <strong>Rounds:</strong> Each round will have different pictures, 1 picture in the
                practice round and 5 in all others.
              </p>
              <p></p>
              <div style={{marginBottom: '20px'}}>
                <strong>Game Board:</strong>
              </div>
              <img src='img/wildcam.gif' />
          ...
          <div
            id='showInstructions'
            className={`${inside || showInstructions ? 'opacity-100' : 'opacity-0'}`}
            ...
            <div style={{marginBottom: '20px'}}>
              ...
              <p>
                {otherPlayers.length > 0
                  ? 'Your team works on the same images and any player may answer any question. Your team will submit one shared response. All players must agree to move on.'
                  : ''}
              </p>
              <ul style={{listStyle: 'disc inside'}}>
                <li>Take a good look at the picture before answering the questions.</li>
                <li>
                  Once you answer all questions for an image, it will automatically progress to the
                  next page. You cannot go back.
                </li>
              </ul>
          ...
          <div
            id='showPerformance'
            className={`${inside || showPerformance ? 'opacity-100' : 'opacity-0'}`}
            style={{marginBottom: '20px'}}
          >
            <p style={{fontSize: '25px'}}> Scoring </p>
            <p>
              Your score is determined by the percentage of questions you answer correctly and will
              be computed at the end of each round.
            </p>
            <div style={{height: '10px'}}></div>
            <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              {!inside && !showPractice ? (
          ...
          <div
            id='showPractice'
            className={`${inside || showPractice ? 'opacity-100' : 'opacity-0'}`}
            style={{marginBottom: '20px'}}
          >
            <p style={{fontSize: '25px'}}> Practice </p>
            <p>
              After the Instructions, there will be a practice round. This practice will not count
              towards your score.
            </p>
            <div style={{height: '10px'}}></div>
            <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              ...
              <FormSection title='Comprehension Check'>
                <FormLabel id='q1' name='What is the main activity of this game?'>
                  <RadioGroup
                    ...
                    options={[
                      {
                        label: 'To annotate images of wild life.',
                        value: 'q1_a',
                      },
                      {
                        label: 'To rate image quality.',
                        value: 'q1_b',
                      },
                      {
                        label: 'To describe landscapes in images.',
                        value: 'q1_c',
                      },
                    ]}
                  />
