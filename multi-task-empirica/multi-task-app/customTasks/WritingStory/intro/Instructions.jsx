        ...
        <div>
          {(inside || showOverview) ? (
            <div style={{marginBottom: '20px'}}>
              <p style={{fontSize: '25px'}}> Overview </p>
                <p>In this game, you will respond to a series of writing prompts.</p>
                <p><strong>Goal:</strong> Address the prompt with a thoughtful written response.</p>
                <p><strong>Rounds:</strong> Will have different prompts.</p>
              <div style={{marginBottom: '20px'}}><strong>Game Board:</strong></div>
              <div>
                <img src='img/writing-story.gif' alt="gif of game" />
              </div>
          ...
          <div id="showInstructions" className={`${inside || showInstructions ? "opacity-100" : "opacity-0"}`} style={{ marginBottom: '20px' }}>
              ...
              <p>
                {otherPlayers.length > 0
                  ? 'Your team works on the same response and will submit one shared response.'
                  : ''}
              </p>
              <ul style={{ listStyle: 'disc inside' }}>
                <li>Use the textbox to write your response.</li>
          ...
          <div id="showPerformance" className={`${inside || showPerformance ? "opacity-100" : "opacity-0"}`} style={{ marginBottom: '20px' }}>
            <p style={{fontSize: '25px'}}> Scoring </p>
              <p>
                Your score is determined by the quality of your response (including length,
                originality, quality of presentation, adequacy and creativity). This score will be
                calculated after the experiment ends.
              </p>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              {(!inside && !showPractice) ? (
                  <Button onClick={() => {
                ...
                <FormLabel id='q1' name='What is the main activity in this game?'>
                  <RadioGroup
                    ...
                    options={[
                      ...
                      {
                        label: 'To make a list of words that are as different as possible.',
                        value: 'q1_b',
                      },
                      {
                        label: 'To brainstorm as many words as possible.',
                        value: 'q1_c',
                      },
                    ]}
                  />
