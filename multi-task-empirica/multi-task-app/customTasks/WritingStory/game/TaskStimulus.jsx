    ...
    return (
      <div className='sandboxWord'>
        ...
        {len >= 1 && (
          ...
          >
            Delete this response to change the final submission.
          </h4>
        )}
        {!(len >= 1) && (
          <h4
          ...
          >
            You should add a final response to the writing prompt here
          </h4>
        )}
        <div className='sandboxWordList bp3-card'>{this.showList(finalWordList)}</div>
      </div>
    );
  }
}
