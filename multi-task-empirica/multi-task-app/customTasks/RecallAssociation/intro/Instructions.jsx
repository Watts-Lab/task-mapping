        ...
        <div>
          {(inside || showOverview) ? (
            <div style={{marginBottom: '20px'}}>
              <p style={{fontSize: '25px'}}> Game Overview </p>
                ...
                <p>
                <strong>Goal:</strong> Accurately recall as many words as possible with minimal error.
                </p>
                <p>
                <strong>Rounds:</strong> Each round will have different lists of words. 
                </p>
              <p></p>
              <div style={{marginBottom: '20px'}}><strong>Game Board:</strong></div>
              <img src="img/recall-association.gif"/>
           ...
           <div id="showInstructions" className={`${inside || showInstructions ? "opacity-100" : "opacity-0"}`} style={{ marginBottom: '20px' }}>
              ...
              <ul style={{ listStyle: 'disc inside'}}>
                <li>Read each list of words so you can remember them. Each list will only be displayed once for a short time.</li>
                <li>After you see all the lists, you will have several math problems to complete.</li>
                <li>After completing the problems, recall as many words as possible and enter them under the correct theme.</li>
                <li>
                  You may not type on your keyboard or switch tabs while the lists are being displayed. 
                  Doing so will lead to suspension from that round of the game, however, you may participate in the following rounds.
                </li>
                <li>
              {otherPlayers.length > 0 ? (
                    "Your team works on the same lists and will submit one shared response. All players can click 'Approve Configuration' to move on."
                ) : (
          ...
          <div id="showPerformance" className={`${inside || showPerformance ? "opacity-100" : "opacity-0"}`} style={{ marginBottom: '20px' }}>
            <p style={{fontSize: '25px'}}> Scoring </p>
              <p>
                Your score is determined by the total number of words you recall correctly. 
                A max score requires you to recall all words correctly.
                Your score will be calculated at the end of each round.
              </p>
              <div style={{ height: "10px"}}></div>
              <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
              {(!inside && !showPractice) ? (
              ...
              <FormSection title='Comprehension Check'>
                <FormLabel id='q1' name='What is the main activity of this game?'>
                  <RadioGroup
                    ...
                    options={[
                      {
                        label: 'To recall displayed words.',
                        value: 'q1_a',
                      },
                      {
                        label: 'To recall synonyms.',
                        value: 'q1_b',
                      },
                      {
                        label: 'To write things in given category.',
                        value: 'q1_c',
                      },
                    ]}
                  />
