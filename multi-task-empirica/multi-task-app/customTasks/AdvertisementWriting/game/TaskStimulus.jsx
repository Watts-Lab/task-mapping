            ...
            return (
              ...
              >
                <Button
                  icon="trash"
                  onClick={() => {
                    logAction(player, "removedWord", item.word);
                ...
                <Button
                  icon="arrow-down"
                  onClick={() => {
                    logAction(player, "movedSloganToFinal", item.word);
  ...
  render() {
    ...
    return (
      <div className="sandboxWord">
        ...
        >
          These phrases will NOT be graded
        </p>
            ...
            return (
              ...
              >
                <Button
                  icon="arrow-up"
                  onClick={() => {
                    logAction(player, "movedSloganToSandbox", item.word);
  ...
  render() {
    ...
    return (
      <div className="sandboxWord">  
        ...
        >
          This slogan will be <strong>graded</strong>.
        </h5>
        {len >= 1 && (
          <h4
        ...
        {!(len >= 1) && (
          ...
          >
            You should add a final slogan here
          </h4>
        )}
        <div className="sandboxWordList bp3-card">
