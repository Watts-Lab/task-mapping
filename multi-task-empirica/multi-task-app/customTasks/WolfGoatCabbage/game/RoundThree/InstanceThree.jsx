...
export default class InstanceThree extends Component {
  constructor(props) {
    super(props);
    /*
     * State codes:
  ...
  moveBoat(paramSide) {
    ...
    if (boatSide !== paramSide) {
      ...
      const goatCaterpillar = sides[1] == propCheck && sides[3] == propCheck;
      const caterpillarCabbage = sides[2] == propCheck && sides[3] == propCheck;

      endConditions([wolfGoat, goatCaterpillar, caterpillarCabbage], stage, player, config, game);
    }
  }
  ...
  renderBoard() {
    ...
    const caterpillarSide = config.sides[3] === 0 ? "left" : "right";
      ...
      <>
        ...
        >
          ...
          >
            ...
            {caterpillarSide === "left" &&
              oneSelected !== "caterpillar" &&
              twoSelected !== "caterpillar" && (
                <Room
              ...
              <div id="boat">
                ...
                {boatSide === "left" && oneSelected !== null && (
                  ...
                  >
                    ...
                    {oneSelected === "caterpillar" && <CaterpillarSvg />}
                  </div>
                )}
                {boatSide === "left" && twoSelected !== null && (
                  ...
                  >
                    ...
                    {twoSelected === "caterpillar" && <CaterpillarSvg />}
                  </div>
                )}
              </div>
            </div>
            <div id="middle">
              <div style={{ marginTop: "1rem", textAlign: "center" }}>
                ...
                >
                  <div style={{ display: "inline", width: "4rem" }}>
                    <Button
                      ...
                      onClick={() => this.moveBoat("left")}
                    >
                      ←
                    </Button>
                    <Button
                      disabled={status === 1 || status === 2}
                      onClick={() => this.moveBoat("right")}
                    >
                      →
                    </Button>
                  </div>
                ...
                <div style={{ display: "block" }}>
                  ...
                  >
                    <Button
                      disabled={status === 1 || status === 2}
                      onClick={() => emptyBoat(2, config, stage)}
                    >
                      Empty boat
                    </Button>
                  </div>
              ...
              >
                ...
                <ul>
                  ...
                  <li>- Goat eats Caterpillar</li>
                  <li>- Caterpillar eats Cabbage</li>
                </ul>
              </div>
                  ...
                  {status === 1 && (
                    <>
                      ...
                      >
                        ...
                        <ul>
                          <li>- Wolf and Goat</li>
                          <li>- Goat and Caterpillar</li>
                          <li>- Caterpillar and Cabbage</li>
                        </ul>
                        <br></br>
                  ...
                  {status === 2 && (
                    ...
                    >
                      <div style={{ textAlign: "center" }}>
                        <p>Complete!</p>
                        <p>
                          Click Approve Configuration to move on or reset to try again
                        </p>
                      </div>
                    </div>
                  )}
