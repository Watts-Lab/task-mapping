  ...
  render() {
    ...
    return (
      <div className="sandboxWord">
        ...
        >
          These ratings will NOT be graded
        </p>
  ...
  render() {
    ...
    return (
      <div className="sandboxWord">  
        ...
        >
          This rating will be <strong>graded</strong>.
        </h5>
        {len >= 1 && (
          <h4
          ...
          >
            Delete this rating to change the final submission.
          </h4>
        )}
        {!(len >= 1) && (
          <h4
          ...
          >
            You should add a final rating here
          </h4>
        )}
        <div className="sandboxWordList bp3-card">
