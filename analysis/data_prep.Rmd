...
## TODO: CONSOLIDATE ALL THE INCONSISTENT ONES INTO A SINGLE CSV

# write.csv(goal_disagreement,"goal_disagreement.csv")
# write.csv(options_disagreement,"options_disagreement.csv")
# write.csv(outcome_disagreement,"outcome_disagreement.csv")
# write.csv(individual_disagreement,"individual_disagreement.csv")
# write.csv(submission_disagreement,"submission_disagreement.csv")
```
...
write.csv(task_clusters_dbscan,"task_clusters_dbscan_kmeans_comparison.csv")
...
ggsave(
  paste("Mapped_task_PCA_Clustered_Colored_AGREEED_", k , ".png", sep = ""),
  width = 7,
  height = 6
)
```
...
```{r}
all_clusters_taxonomies <- read_csv("consolidated_clusters_by_taxonomy_renumbered.csv") %>%
  arrange(id)
...
ggsave(
  paste("SHAW_sharedaxis_Mapped_task_PCA_Clustered_Colored_", k , ".png", sep = ""),
  width = 7,
  height = 6
)
```
