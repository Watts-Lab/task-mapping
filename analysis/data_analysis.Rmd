...
type_7_cols <- mcgrath_data%>%select(c("conflict_cooperation","external_adversary"))
  ...
  for (i in 1:nrow(mcgrath_data)) {
    task = mcgrath_data$task_names[i]
    mcgrath_quadrant_labels_cont$generate.planning[i] = type_1_cols$type_1
    mcgrath_quadrant_labels_cont$generate.creativity[i] = type_2_cols$type_2

    mcgrath_quadrant_labels_cont$choose.intellective[i] = type_3_cols$type_3
    mcgrath_quadrant_labels_cont$choose.decision[i] = type_4_cols$type_4

    mcgrath_quadrant_labels_cont$negotiate.cogconf[i] = type_5_cols$type_5
    mcgrath_quadrant_labels_cont$negotiate.mixmotive[i] = type_6_cols$type_6

    mcgrath_quadrant_labels_cont$execute.contest[i] = type_7_cols$type_7
    mcgrath_quadrant_labels_cont$execute.performance[i] = type_8_cols$type_8
  }
