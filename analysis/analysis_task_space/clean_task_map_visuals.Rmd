...
# Load the Data
```{r}
task_map <- read_csv('../../outputs/task_map.csv')
```
...
```{r}
task_map_with_intuitive_labels <- read_csv('../../data/task_map_with_intuitive_hand_groupings.csv') %>%
  mutate(
...
ggsave(
    plot = p,
  filename = "../../outputs/task_map_with_intuitive_illustrations_raw.svg",
    width = 14,
    height = 5,
    device = "svg"
)
