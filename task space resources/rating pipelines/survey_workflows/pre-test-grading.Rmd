...
```{r}
# SECURITY: Do not hard-code API keys. Provide your own Qualtrics key via environment variable QUALTRICS_API_KEY.
# Example: Sys.setenv(QUALTRICS_API_KEY="<your-key>") before knitting, or set it in your shell environment.
