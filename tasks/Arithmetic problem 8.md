# Summary
In this task, all group members receive different clues, and have to collaborate to reach a solution to the problem. The problem involves figuring out the shortest route a moving van should follow.
...
The correct solution is ACBED (350 miles)
