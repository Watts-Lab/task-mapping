# Summary
In this task, all group members receive different clues, and have to collaborate to reach a solution to the problem. The problem involves figuring out the type of appliance to manufacture that will yield the greatest total net profit.
